<x-app-layout meta-title="Create File | Drive MSPS">
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Actualizar Unidad') }} [ {{ $unit->name }} ]
        </h2>
    </x-slot>
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('unit.update', [$unit->id]) }}" method="POST">
                        ...
                        <div>
                            ...
                            value="{{ old('nmae') ?? $unit->code }}" required autofocus autocomplete="code" />
                        ...
                        <div>
                            ...
                            <x-text-input id="name" class="block mt-1 w-full" type="text" name="name"
                                value="{{ old('nmae') ?? $unit->name }}" required autofocus autocomplete="name" />
                        ...
                        <div class="mt-4">
                            ...
                            value="{{ old('details') ?? $unit->details }}" autofocus autocomplete="details" />
